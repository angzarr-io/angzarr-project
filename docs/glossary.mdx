...
Angzarr "domain" is **not** equivalent to DDD "bounded context." A bounded context may contain multiple Angzarr domains. See [Domain](/glossary/domain) and [Bounded Context](/glossary/bounded-context) for details.
:::
