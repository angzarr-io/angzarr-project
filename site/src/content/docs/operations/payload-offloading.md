...
```protobuf file=proto/angzarr_client/proto/angzarr/v1/types.proto region=payload_reference
```
...
```protobuf file=proto/angzarr_client/proto/angzarr/v1/types.proto region=dlq_details
```
