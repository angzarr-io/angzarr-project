...
```protobuf file=proto/angzarr_client/proto/angzarr/types.proto region=dead_letter
```
...
```protobuf file=proto/angzarr_client/proto/angzarr/types.proto region=rejection_notification
```
