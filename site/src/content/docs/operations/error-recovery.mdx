...
```protobuf file=proto/angzarr_client/proto/angzarr/v1/types.proto region=dead_letter
```
...
```protobuf file=proto/angzarr_client/proto/angzarr/v1/types.proto region=rejection_notification
```
