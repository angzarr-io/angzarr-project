---
title: Temporal Branching with Editions
---
...
```protobuf file=proto/angzarr_client/proto/angzarr/v1/types.proto region=edition
```

To branch, specify an edition name:

```python title="illustrative - speculative edition"
...
```python title="illustrative - explicit divergence points"
edition = Edition(
    name="backtest-q4",
    divergences=[
...
flowchart LR
    subgraph Prod["Production Environment"]
        Main["Event Store (main)<br/>- orders<br/>- inventory"]
    end
    subgraph Iso["Isolated Environment"]
        Copy["Event Store (copy)<br/>- orders<br/>- inventory"]
        Runs["Run editions here<br/>- backtests<br/>- what-if analysis<br/>- ML training"]
        Copy --> Runs
    end
    Main -->|copy| Copy
```
