...
```protobuf file=proto/angzarr_client/proto/angzarr/v1/types.proto region=event_page
```

```protobuf file=proto/angzarr_client/proto/angzarr/v1/types.proto region=aggregate_snapshot
```

```protobuf file=proto/angzarr_client/proto/angzarr/v1/types.proto region=event_book
```
...
```protobuf file=proto/angzarr_client/proto/angzarr/v1/types.proto region=sync_mode
```
...
```protobuf file=proto/angzarr_client/proto/angzarr/v1/stream.proto region=event_stream_service
```
