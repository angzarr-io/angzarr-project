...
```python file=vendor/examples/python/prj-cloudevents/cloudevents_projector.py region=cloudevents_oo
```

Router-style alternative with explicit handler registration:

```python file=vendor/examples/python/prj-cloudevents/cloudevents_projector.py region=cloudevents_router
```
